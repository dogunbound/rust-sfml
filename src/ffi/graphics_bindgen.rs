...
pub fn sfCircleShape_getGeometricCenter(shape: *const sfCircleShape) -> sfVector2f;
...
pub fn sfConvexShape_getGeometricCenter(shape: *const sfConvexShape) -> sfVector2f;
...
pub fn sfCustomShape_setOrigin(shape: *mut sfCustomShape, origin: sfVector2f);
pub fn sfCustomShape_getPosition(shape: *const sfCustomShape) -> sfVector2f;
pub fn sfCustomShape_getRotation(shape: *const sfCustomShape) -> f32;
pub fn sfCustomShape_getScale(shape: *const sfCustomShape) -> sfVector2f;
pub fn sfCustomShape_getOrigin(shape: *const sfCustomShape) -> sfVector2f;
pub fn sfCustomShape_move(shape: *mut sfCustomShape, offset: sfVector2f);
pub fn sfCustomShape_rotate(shape: *mut sfCustomShape, angle: f32);
pub fn sfCustomShape_scale(shape: *mut sfCustomShape, factors: sfVector2f);
pub fn sfCustomShape_getTransform(shape: *const sfCustomShape) -> *const sfTransform;
pub fn sfCustomShape_getInverseTransform(shape: *const sfCustomShape) -> *const sfTransform;
pub fn sfCustomShape_setTexture(shape: *mut sfCustomShape, texture: *const sfTexture, resetRect: bool);
pub fn sfCustomShape_setTextureRect(shape: *mut sfCustomShape, rect: sfIntRect);
pub fn sfCustomShape_setFillColor(shape: *mut sfCustomShape, color: sfColor);
pub fn sfCustomShape_setOutlineColor(shape: *mut sfCustomShape, color: sfColor);
pub fn sfCustomShape_setOutlineThickness(shape: *mut sfCustomShape, thickness: f32);
pub fn sfCustomShape_getTexture(shape: *const sfCustomShape) -> *const sfTexture;
pub fn sfCustomShape_getTextureRect(shape: *const sfCustomShape) -> sfIntRect;
pub fn sfCustomShape_getFillColor(shape: *const sfCustomShape) -> sfColor;
pub fn sfCustomShape_getOutlineColor(shape: *const sfCustomShape) -> sfColor;
pub fn sfCustomShape_getOutlineThickness(shape: *const sfCustomShape) -> f32;
pub fn sfCustomShape_getPointCount(shape: *const sfCustomShape) -> usize;
pub fn sfCustomShape_getGeometricCenter(shape: *const sfCustomShape) -> sfVector2f;
pub fn sfCustomShape_getPoint(shape: *const sfCustomShape, index: usize) -> sfVector2f;
pub fn sfCustomShape_getLocalBounds(shape: *const sfCustomShape) -> sfFloatRect;
...
pub fn sfFont_openFromFile(font: *mut sfFont, filename: *const c_char) -> bool;
pub fn sfFont_openFromMemory(font: *mut sfFont, data: *const u8, sizeInBytes: usize) -> bool;
...
pub fn sfImage_resizeWithColor(image: *mut sfImage, size: sfVector2u, color: sfColor);
pub fn sfImage_resizeWithPixels(image: *mut sfImage, size: sfVector2u, pixels: *const u8);
...
pub fn sfImage_saveToMemory(image: *const sfImage, format: *const c_char) -> *mut sfBuffer;
pub fn sfImage_createMaskFromColor(image: *mut sfImage, colorKey: sfColor, alpha: u8);
pub fn sfImage_copy(image: *mut sfImage, source: *const sfImage, dest: sfVector2u, sourceRect: sfIntRect, applyAlpha: bool) -> bool;
pub fn sfImage_setPixel(image: *mut sfImage, coords: sfVector2u, color: sfColor);
pub fn sfImage_getPixel(image: *const sfImage, coords: sfVector2u) -> sfColor;
...
pub fn sfRectangleShape_getGeometricCenter(shape: *const sfRectangleShape) -> sfVector2f;
...
pub fn sfRenderTexture_clearStencil(renderTexture: *mut sfRenderTexture, stencilValue: sfStencilValue);
pub fn sfRenderTexture_clearColorAndStencil(renderTexture: *mut sfRenderTexture, color: sfColor, stencilValue: sfStencilValue);
...
pub fn sfRenderTexture_getScissor(renderTexture: *const sfRenderTexture, view: *const sfView) -> sfIntRect;
...
// RenderWindow.cpp
pub fn sfRenderWindow_new_mtsss(mode: sfVideoMode, title: *const u32, style: u32, state: sfState, settings: *const sfContextSettings) -> *mut sfRenderWindow;
...
pub fn sfRenderWindow_waitEvent(renderWindow: *mut sfRenderWindow, event: *mut sfEvent, timeout: i64) -> bool;
...
pub fn sfRenderWindow_setMinimumSize(renderWindow: *mut sfRenderWindow, size: *const sfVector2u);
pub fn sfRenderWindow_setMaximumSize(renderWindow: *mut sfRenderWindow, size: *const sfVector2u);
...
pub fn sfRenderWindow_setIcon(renderWindow: *mut sfRenderWindow, size: sfVector2u, pixels: *const u8);
...
pub fn sfRenderWindow_getNativeHandle(renderWindow: *const sfRenderWindow) -> sfWindowHandle;
pub fn sfRenderWindow_clear(renderWindow: *mut sfRenderWindow, color: sfColor);
pub fn sfRenderWindow_clearStencil(renderWindow: *mut sfRenderWindow, stencilValue: sfStencilValue);
pub fn sfRenderWindow_clearColorAndStencil(renderWindow: *mut sfRenderWindow, color: sfColor, stencilValue: sfStencilValue);
...
pub fn sfRenderWindow_getScissor(renderWindow: *const sfRenderWindow, view: *const sfView) -> sfIntRect;
...
// Sprite.cpp
pub fn sfSprite_new(texture: *const sfTexture, rect: sfIntRect) -> *mut sfSprite;
...
pub fn sfSprite_setTextureRect(sprite: *mut sfSprite, rect: sfIntRect);
...
// Text.cpp
pub fn sfText_new(font: *const sfFont, string: *const u32, size: c_uint) -> *mut sfText;
...
pub fn sfTexture_resize(texture: *mut sfTexture, size: sfVector2u, sRgb: bool) -> bool;
pub fn sfTexture_loadFromFile(tex: *mut sfTexture, filename: *const c_char, sRgb: bool, area: sfIntRect) -> bool;
pub fn sfTexture_loadFromMemory(tex: *mut sfTexture, data: *const c_void, sizeInBytes: usize, sRgb: bool, area: sfIntRect) -> bool;
pub fn sfTexture_loadFromStream(tex: *mut sfTexture, stream: *mut sfInputStreamHelper, sRgb: bool, area: sfIntRect) -> bool;
pub fn sfTexture_loadFromImage(tex: *mut sfTexture, image: *const sfImage, sRgb: bool, area: sfIntRect) -> bool;
...
pub fn sfTexture_updateFromPixels(texture: *mut sfTexture, pixels: *const u8, size: sfVector2u, dest: sfVector2u);
pub fn sfTexture_updateFromTexture(destination: *mut sfTexture, texture: *const sfTexture, dest: sfVector2u);
pub fn sfTexture_updateFromImage(texture: *mut sfTexture, image: *const sfImage, dest: sfVector2u);
pub fn sfTexture_updateFromWindow(texture: *mut sfTexture, window: *const sfWindow, dest: sfVector2u);
pub fn sfTexture_updateFromRenderWindow(texture: *mut sfTexture, renderWindow: *const sfRenderWindow, dest: sfVector2u);
...
pub fn sfTransform_translate(transform: *mut sfTransform, offset: sfVector2f);
pub fn sfTransform_rotate(transform: *mut sfTransform, angle: f32);
pub fn sfTransform_rotateWithCenter(transform: *mut sfTransform, angle: f32, center: sfVector2f);
pub fn sfTransform_scale(transform: *mut sfTransform, scale: sfVector2f);
pub fn sfTransform_scaleWithCenter(transform: *mut sfTransform, scale: sfVector2f, center: sfVector2f);
// VertexBuffer.cpp
...
pub fn sfView_setScissor(view: *mut sfView, scissor: sfFloatRect);
...
pub fn sfView_getScissor(view: *const sfView) -> sfFloatRect;
